...
import { Avatar, Button, Dialog, DialogActions, DialogContent, DialogTitle, Divider } from "@mui/material";
      ...
      <div className=" grid grid-cols-2 max-sm:grid-cols-1 gap-4 sm:gap-6">
        <div className=" w-full h-full flex flex-col gap-2">
          <div className=" flex-center flex-col gap-4 w-full">
            <h1 className=" mt-8 mb-4 font-medium text-3xl">Your Profile</h1>
